...
EMSETTINGS =  --preload-file webdata@ -fsanitize=undefined -fsanitize-minimal-runtime -s USE_SDL=2 -s STACK_SIZE=128MB -s INITIAL_MEMORY=256MB -s EMULATE_FUNCTION_POINTER_CASTS=0 -s ASSERTIONS -s STACK_OVERFLOW_CHECK
...
# -s TOTAL_STACK=20mb -s TOTAL_STACK=64MB -s INITIAL_MEMORY=10mb -s ALLOW_MEMORY_GROWTH=1 -s EMULATE_FUNCTION_POINTER_CASTS=0

LIBS = -lSDL2 -lm

DEFINES = -DPC -DPLATFORM_PC -DPPM_SUPPORT_ENABLED -DSYSCALL_WRAPPERS=24 -DSVS_RND_FUNCTION="rand()"
